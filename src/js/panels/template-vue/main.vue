...
<template>
  <div class="app" :style="{ backgroundColor: backgroundColor }">
    <header class="app-header">
      <img src="../../assets/logos/bolt-cep.svg" class="icon" />
      <div class="stack-icons">
        <div>
          <img src="../../assets/logos/vite.svg" />
          Vite
        </div>
        +
        <div>
          <img src="../../assets/logos/vue.svg" />
          Vue
        </div>
        +
        <div>
      ...
      <div class="button-group">
        ...
        <button @click="nodeTest">
          <img class="icon-button" src="../../assets/logos/node-js.svg" />
        </button>
        <button @click="jsxTest">
          <img class="icon-button" src="../../assets/logos/adobe.svg" />
        </button>
